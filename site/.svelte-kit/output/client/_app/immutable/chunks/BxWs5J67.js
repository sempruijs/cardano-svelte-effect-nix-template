...
for (var P = 0, Mr = z.length; P < Mr; ++P)
  (_[P] = z[P]), (C[z.charCodeAt(P)] = P);
C[45] = 62;
C[95] = 63;
function fr(p) {
  var f = p.length;
...
function Dr(p) {
  ...
  for (B = 0; B < m; B += 4)
    (f =
      (C[p.charCodeAt(B)] << 18) |
      (C[p.charCodeAt(B + 1)] << 12) |
      (C[p.charCodeAt(B + 2)] << 6) |
      C[p.charCodeAt(B + 3)]),
      (c[s++] = (f >> 16) & 255),
      (c[s++] = (f >> 8) & 255),
      (c[s++] = f & 255);
  return (
    w === 2 &&
      ((f = (C[p.charCodeAt(B)] << 2) | (C[p.charCodeAt(B + 1)] >> 4)),
      (c[s++] = f & 255)),
    w === 1 &&
      ((f =
        (C[p.charCodeAt(B)] << 10) |
        (C[p.charCodeAt(B + 1)] << 4) |
        (C[p.charCodeAt(B + 2)] >> 2)),
      (c[s++] = (f >> 8) & 255),
      (c[s++] = f & 255)),
    c
  );
...
function $r(p, f, a) {
  for (var x, w = [], c = f; c < a; c += 3)
    (x =
      ((p[c] << 16) & 16711680) + ((p[c + 1] << 8) & 65280) + (p[c + 2] & 255)),
      w.push(Pr(x));
  return w.join("");
}
function Or(p) {
  for (
    var f, a = p.length, x = a % 3, w = [], c = 16383, s = 0, m = a - x;
    s < m;
    s += c
  )
    w.push($r(p, s, s + c > m ? m : s + c));
  return (
    x === 1
      ? ((f = p[a - 1]), w.push(_[f >> 2] + _[(f << 4) & 63] + "=="))
      : x === 2 &&
        ((f = (p[a - 2] << 8) + p[a - 1]),
        w.push(_[f >> 10] + _[(f >> 4) & 63] + _[(f << 2) & 63] + "=")),
    w.join("")
  );
}
var J = {};
/*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */
J.read = function (p, f, a, x, w) {
  var c,
    s,
    m = w * 8 - x - 1,
    B = (1 << m) - 1,
    ...
    R = p[f + U];
  for (
    U += b, c = R & ((1 << -o) - 1), R >>= -o, o += m;
    o > 0;
    c = c * 256 + p[f + U], U += b, o -= 8
  );
  for (
    s = c & ((1 << -o) - 1), c >>= -o, o += x;
    o > 0;
    s = s * 256 + p[f + U], U += b, o -= 8
  );
  if (c === 0) c = 1 - A;
  else {
    if (c === B) return s ? NaN : (R ? -1 : 1) * (1 / 0);
    (s = s + Math.pow(2, x)), (c = c - A);
  }
  return (R ? -1 : 1) * s * Math.pow(2, c - x);
};
J.write = function (p, f, a, x, w, c) {
  var s,
    m,
    B,
    A = c * 8 - w - 1,
    o = (1 << A) - 1,
    U = o >> 1,
    b = w === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0,
    R = x ? 0 : c - 1,
    M = x ? 1 : -1,
    Y = f < 0 || (f === 0 && 1 / f < 0) ? 1 : 0;
  for (
    f = Math.abs(f),
      isNaN(f) || f === 1 / 0
        ...
        : ((s = Math.floor(Math.log(f) / Math.LN2)),
          ...
          s + U >= 1 ? (f += b / B) : (f += b * Math.pow(2, 1 - U)),
          f * B >= 2 && (s++, (B /= 2)),
          s + U >= o
            ? ((m = 0), (s = o))
            : s + U >= 1
              ? ((m = (f * B - 1) * Math.pow(2, w)), (s = s + U))
              : ((m = f * Math.pow(2, U - 1) * Math.pow(2, w)), (s = 0)));
    w >= 8;
    p[a + R] = m & 255, R += M, m /= 256, w -= 8
  );
  for (
    s = (s << w) | m, A += w;
    A > 0;
    p[a + R] = s & 255, R += M, s /= 256, A -= 8
  );
  p[a + R - M] |= Y * 128;
};
/*!
...
(function (p) {
  const f = G,
    ...
    x =
      typeof Symbol == "function" && typeof Symbol.for == "function"
        ...
        : null;
  (p.Buffer = o), (p.SlowBuffer = lr), (p.INSPECT_MAX_BYTES = 50);
  const w = 2147483647;
  p.kMaxLength = w;
  const { Uint8Array: c, ArrayBuffer: s, SharedArrayBuffer: m } = globalThis;
  ...
  o.poolSize = 8192;
  function U(i, r, t) {
    if (typeof i == "string") return Y(i, r);
    if (s.isView(i)) return pr(i);
    if (i == null)
      throw new TypeError(
    ...
    if (
      S(i, s) ||
      (i && S(i.buffer, s)) ||
      (typeof m < "u" && (S(i, m) || (i && S(i.buffer, m))))
    )
      return W(i, r, t);
    if (typeof i == "number")
      throw new TypeError(
  ...
  function j(i) {
    const r = i.length < 0 ? 0 : X(i.length) | 0,
      t = A(r);
  ...
  function sr(i) {
    if (o.isBuffer(i)) {
      const r = X(i.length) | 0,
        t = A(r);
      return t.length === 0 || i.copy(t, 0, 0, r), t;
    }
    if (i.length !== void 0)
      return typeof i.length != "number" || V(i.length) ? A(0) : j(i);
    if (i.type === "Buffer" && Array.isArray(i.data)) return j(i.data);
  }
  function X(i) {
    if (i >= w)
      throw new RangeError(
  ...
  (o.isBuffer = function (r) {
    ...
    (o.compare = function (r, t) {
      if (
        (S(r, c) && (r = o.from(r, r.offset, r.byteLength)),
        S(t, c) && (t = o.from(t, t.offset, t.byteLength)),
  ...
  function K(i, r) {
    ...
    if (s.isView(i) || S(i, s)) return i.byteLength;
    if (typeof i != "string")
      throw new TypeError(
  ...
  (o.prototype.swap16 = function () {
    ...
    (o.prototype.compare = function (r, t, n, e, u) {
      if ((S(r, c) && (r = o.from(r, r.offset, r.byteLength)), !o.isBuffer(r)))
        throw new TypeError(
  ...
  function Z(i, r, t, n, e) {
    ...
    if (typeof r == "number")
      return (
        (r = r & 255),
        typeof c.prototype.indexOf == "function"
          ? e
            ? c.prototype.indexOf.call(i, r, t)
            : c.prototype.lastIndexOf.call(i, r, t)
          : Q(i, [r], t, n, e)
      );
    ...
    if (e) {
      ...
      for (E = t; E < h; E++)
        if (d(i, E) === d(r, g === -1 ? 0 : E - g)) {
          if ((g === -1 && (g = E), E - g + 1 === l)) return g * u;
        } else g !== -1 && (E -= E - g), (g = -1);
    } else
      for (t + l > h && (t = h - l), E = t; E >= 0; E--) {
        let g = true;
        for (let y = 0; y < l; y++)
          if (d(i, E + y) !== d(r, y)) {
            g = false;
  ...
  (o.prototype.includes = function (r, t, n) {
    ...
    (o.prototype.indexOf = function (r, t, n) {
      return Z(this, r, t, n, true);
    }),
    (o.prototype.lastIndexOf = function (r, t, n) {
      return Z(this, r, t, n, false);
    });
  function wr(i, r, t, n) {
    t = Number(t) || 0;
    const e = i.length - t;
  ...
  function Er(i, r, t, n) {
    return O(Sr(r, i.length - t), i, t, n);
  }
  ...
  function gr(i) {
    const r = i.length;
    if (r <= rr) return String.fromCharCode.apply(String, i);
    let t = "",
      n = 0;
    for (; n < r; )
      t += String.fromCharCode.apply(String, i.slice(n, (n += rr)));
    return t;
  }
  function mr(i, r, t) {
    let n = "";
  ...
  (o.prototype.readUintLE = o.prototype.readUIntLE =
    ...
    (o.prototype.readFloatLE = function (r, t) {
      return (
        (r = r >>> 0), t || F(r, 4, this.length), a.read(this, r, true, 23, 4)
      );
    }),
    (o.prototype.readFloatBE = function (r, t) {
      return (
        (r = r >>> 0), t || F(r, 4, this.length), a.read(this, r, false, 23, 4)
      );
    }),
    (o.prototype.readDoubleLE = function (r, t) {
      return (
        (r = r >>> 0), t || F(r, 8, this.length), a.read(this, r, true, 52, 8)
      );
    }),
    (o.prototype.readDoubleBE = function (r, t) {
      return (
        (r = r >>> 0), t || F(r, 8, this.length), a.read(this, r, false, 52, 8)
      );
    });
  function T(i, r, t, n, e, u) {
    if (!o.isBuffer(i))
  ...
  (o.prototype.writeBigUInt64LE = L(function (r, t = 0) {
    ...
    (o.prototype.writeInt32LE = function (r, t, n) {
      return (
        (r = +r),
        (t = t >>> 0),
        n || T(this, r, t, 4, 2147483647, -2147483648),
        (this[t] = r & 255),
        (this[t + 1] = r >>> 8),
        (this[t + 2] = r >>> 16),
        (this[t + 3] = r >>> 24),
  ...
  (o.prototype.writeDoubleLE = function (r, t, n) {
    ...
    (o.prototype.copy = function (r, t, n, e) {
      ...
      const u = e - n;
      return (
        this === r && typeof c.prototype.copyWithin == "function"
          ? this.copyWithin(t, n, e)
          : c.prototype.set.call(r, this.subarray(n, e), t),
        u
      );
    }),
    (o.prototype.fill = function (r, t, n, e) {
      ...
      if (typeof r == "number") for (u = t; u < n; ++u) this[u] = r;
        ...
        for (u = 0; u < n - t; ++u) this[u + t] = h[u % l];
      }
      return this;
    });
  const k = {};
  ...
  function Ur(i, r, t) {
    D(r, "offset"),
      (i[r] === void 0 || i[r + t] === void 0) && $(r, i.length - (t + 1));
  }
  function hr(i, r, t, n, e, u) {
    if (i > t || i < r) {
      const h = typeof r == "bigint" ? "n" : "";
      let l;
      throw (
        (r === 0 || r === BigInt(0)
          ? (l = `>= 0${h} and < 2${h} ** ${(u + 1) * 8}${h}`)
          : (l = `>= -(2${h} ** ${(u + 1) * 8 - 1}${h}) and < 2 ** ${(u + 1) * 8 - 1}${h}`),
        new k.ERR_OUT_OF_RANGE("value", l, i))
      );
    }
    Ur(n, e, u);
  }
  function D(i, r) {
    if (typeof i != "number") throw new k.ERR_INVALID_ARG_TYPE(r, "number", i);
  }
  function $(i, r, t) {
    throw Math.floor(i) !== i
      ? (D(i, t), new k.ERR_OUT_OF_RANGE("offset", "an integer", i))
      : r < 0
        ? new k.ERR_BUFFER_OUT_OF_BOUNDS()
        : new k.ERR_OUT_OF_RANGE("offset", `>= 0 and <= ${r}`, i);
  }
  const Tr = /[^+/0-9A-Za-z-_]/g;
  function Rr(i) {
    if (((i = i.split("=")[0]), (i = i.trim().replace(Tr, "")), i.length < 2))
      return "";
...
const Gr = I.Buffer,
  ...
  Xr = I.File,
  qr = I.FileOptions,
  Hr = I.INSPECT_MAX_BYTES,
  Vr = I.SlowBuffer,
  zr = I.TranscodeEncoding,
  Jr = I.atob,
  Kr = I.btoa,
  Zr = I.constants,
  Qr = I.isAscii,
  vr = I.isUtf8,
  rt = I.kMaxLength,
  tt = I.kStringMaxLength,
  it = I.resolveObjectURL,
  nt = I.transcode,
  ot = Object.freeze(
    Object.defineProperty(
      {
        ...
        File: Xr,
        FileOptions: qr,
        INSPECT_MAX_BYTES: Hr,
        SlowBuffer: Vr,
        TranscodeEncoding: zr,
        atob: Jr,
        btoa: Kr,
        constants: Zr,
        default: Gr,
...
export { Gr as B, Wr as a, ot as d };
