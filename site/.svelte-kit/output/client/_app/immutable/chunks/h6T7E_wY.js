...
const ue = {
  ...
  getOwnPropertyDescriptor(e, r) {
    if (!e.exclude.includes(r) && r in e.props)
      return { enumerable: true, configurable: true, value: e.props[r] };
  },
  has(e, r) {
...
const le = {
  ...
  has(e, r) {
    ...
    for (let s of e.props)
      if ((I(s) && (s = s()), s != null && r in s)) return true;
    return false;
  },
  ownKeys(e) {
    const r = [];
...
function de(e, r, s, n) {
  ...
  var R = F in e || G in e,
    p =
      (f &&
        (((_a = D(e, r)) == null ? void 0 : _a.set) ??
          (R && r in e && ((i) => (e[r] = i))))) ||
      void 0,
    u = n,
    o = true,
    d = false,
    g = () => ((d = true), o && ((o = false), v ? (u = y(n)) : (u = n)), u);
  ...
  return (
    ...
    function (i, b) {
      if (arguments.length > 0) {
        ...
        if (!_.equals(T)) {
          if (((A = true), ee(E, T), d && u !== void 0 && (u = T), B(_)))
            return i;
          y(() => h(_));
        }
        return i;
...
export { _e as c, ce as i, de as p, pe as r, ve as s };
