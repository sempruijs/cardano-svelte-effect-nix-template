...
function Pr(p, c, a) {
  for (var x, w = [], f = c; f < a; f += 3) x = (p[f] << 16 & 16711680) + (p[f + 1] << 8 & 65280) + (p[f + 2] & 255), w.push($r(x));
  return w.join("");
}
function Or(p) {
  for (var c, a = p.length, x = a % 3, w = [], f = 16383, l = 0, m = a - x; l < m; l += f) w.push(Pr(p, l, l + f > m ? m : l + f));
  return x === 1 ? (c = p[a - 1], w.push(_[c >> 2] + _[c << 4 & 63] + "==")) : x === 2 && (c = (p[a - 2] << 8) + p[a - 1], w.push(_[c >> 10] + _[c >> 4 & 63] + _[c << 2 & 63] + "=")), w.join("");
}
var z = {};
/*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */
z.read = function(p, c, a, x, w) {
...
*/
(function(p) {
  const c = O, a = z, x = typeof Symbol == "function" && typeof Symbol.for == "function" ? Symbol.for("nodejs.util.inspect.custom") : null;
  ...
  function Z(i, r, t, n, e) {
    ...
    if (typeof r == "string" && (r = o.from(r, n)), o.isBuffer(r)) return r.length === 0 ? -1 : Q(i, r, t, n, e);
    if (typeof r == "number") return r = r & 255, typeof f.prototype.indexOf == "function" ? e ? f.prototype.indexOf.call(i, r, t) : f.prototype.lastIndexOf.call(i, r, t) : Q(i, [r], t, n, e);
  ...
  function Er(i, r, t, n) {
    return P(_r(r, i.length - t), i, t, n);
  }
  ...
  function gr(i) {
    ...
    let t = "", n = 0;
    for (; n < r; ) t += String.fromCharCode.apply(String, i.slice(n, n += rr));
    return t;
  }
  function mr(i, r, t) {
    let n = "";
  ...
  function er(i, r, t, n, e) {
    return r = +r, t = t >>> 0, e || nr(i, r, t, 4), a.write(i, r, t, n, 23, 4), t + 4;
  }
  ...
  function or(i, r, t, n, e) {
    return r = +r, t = t >>> 0, e || nr(i, r, t, 8), a.write(i, r, t, n, 52, 8), t + 8;
  }
  ...
  q("ERR_BUFFER_OUT_OF_BOUNDS", function(i) {
    ...
    return Number.isInteger(t) && Math.abs(t) > 2 ** 32 ? e = ur(String(t)) : typeof t == "bigint" && (e = String(t), (t > BigInt(2) ** BigInt(32) || t < -(BigInt(2) ** BigInt(32))) && (e = ur(e)), e += "n"), n += ` It must be ${r}. Received ${e}`, n;
  }, RangeError);
  function ur(i) {
    let r = "", t = i.length;
    const n = i[0] === "-" ? 1 : 0;
  ...
  function Ur(i, r, t) {
    k(r, "offset"), (i[r] === void 0 || i[r + t] === void 0) && $(r, i.length - (t + 1));
  }
